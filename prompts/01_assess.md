...
```json
{
  "company_summary": "2-3 sentence description of the business, their current situation, and where they are in the sales process. Include their activity type, location, and one key distinguishing fact.",
  "activity_type": "one of: scuba_diving | helicopter | general_admission | boat_tour | walking_tour | wildlife | multi_day | null — infer from primary_types, client_segments, lead_type, and company_summary. Use null if the activity type is unclear or does not match any of the known types.",
  "deal_context": {
